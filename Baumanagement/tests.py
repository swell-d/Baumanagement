...
class UrlTests(TestCase):
    def setUp(self):
        ...
        self.Contract = Contract.objects.create(name='test', project_id=1, company_id=1, amount=1)
        self.Payment = Payment.objects.create(name='test', contract_id=1, amount=1)
        self.Bill = Bill.objects.create(name='test', contract_id=1, amount=1)
