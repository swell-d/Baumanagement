    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency', models.ForeignKey(default=Baumanagement.models.models_currency.Currency.get_EUR_id, on_delete=django.db.models.deletion.RESTRICT, related_name='contracts', to='Baumanagement.currency', verbose_name='Currency')),
            ],
            options={
